...
# 
# 
# <div style="text-align: right"> *Disclaimer: Above are my not-that-great analogies and do not accurately reflect the physics. I hope it's a fun opening. </div>
...
# name: directive-fig
# ---
# Sand Ripples took in front of Alupang Beach Tower, Guam. As the bottom water particles contain much momentum for shallow water waves, they can move the sands back and forth and leave the "footprint" of waves.
# 
# ```
# 
...
# name: directive-fig
# ---
# Shallow Water Wave, Animations by Kraaiennest, [Wikimedia Commons, Creative Commons A S-A 3.0](http://commons.wikimedia.org/wiki/File:Shallow_water_wave.gif). Notice the particles from surface to bottom all move significantly.
# 
# ```
# 
...
# name: directive-fig
# ---
# Deep Water Wave, Animations by Kraaiennest, [Wikimedia Commons, Creative Commons A S-A 3.0](http://commons.wikimedia.org/wiki/File:Deep_water_wave.gif). Notice the particles near the bottom barely move.
# 
# ```
# 
# <!-- <figure>
...
# name: directive-fig
# ---
# Fr=1 illustration by [Dr. Mirjam S. Glessmer](https://mirjamglessmer.com/tag/hydraulic-jump/). You're watching a "stationary wave", that gets caught by the background flow.
# ```
# 
# <!-- <figure>
#     <a title="Fr=1 illustration by Dr. Mirjam S. Glessmer" href="https://mirjamglessmer.com/tag/hydraulic-jump/"><img width="480" alt="Fr = 1" src=hydraulics/Fr1.gif></a>
...
# name: directive-fig
# ---
# Fig. 2.1 in [Morozov et al. (2021)](https://link.springer.com/book/10.1007/978-3-030-83074-8) Bottom topography and main deep cataracts of the Atlantic Ocean. Red and magenta ellipses show the cataracts related and not related to the propagation of Antarctic waters in the abyss of the World Ocean. The arrows show the general direction of the flow in the cataracts. The weir formula can help us estimate the volume fluxes of the overflow.
# ```
# 
# <!-- <figure>
...
# name: directive-fig
# ---
# Tidal bore ('bore' and 'jump' are essentially the same here) shot in Laniakea Beach, Honolulu. Note the "water wall" built at the turtle's face, the sediment and seaweed clouds and the water splashes suggest the turbulent nature of the bore.
# ```
# 
...
# **Thought experiment (think first):** <br /> Suppose that the reservoir is fed by river runoff and drained at the same rate by the discharge over the dam. The whole system is in a steady state. Now somehow the elevation of the dam crest is raised. How would the system adjust to the change of topography?
# 
